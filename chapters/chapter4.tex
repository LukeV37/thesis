...
may differ between simulation and data due to mismodelling effects. To account for this,
...
since the tagger response depends on the flavour composition and kinematics of the jet.
...
the $Z$ boson is a colour-singlet resonance with a mass close to the Higgs boson mass,
...
point selections. The mistag rate is not the same in MC and data due to mismodelling
...
degrees of freedom: $\mu$ and $SF$. Here $\mu$ is the $t\bar{t}$ normalisation factor
that accounts for the overall normalisation difference between MC and data, and $SF$
...
Since no floating normalisation factors are applied to the backgrounds, a region in
