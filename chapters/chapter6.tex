...
\begin{figure}
	\centering
	\includegraphics[width=0.8\linewidth]{figures/chapter6/VBF_Signal_and_Background.png}
	\caption{}
...
\begin{figure}[h]
	...
	\begin{subfigure}{.49\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{figures/chapter6/fig_01a.png}
		\caption{}
		\label{fig:sub1}
	\end{subfigure}%
	\begin{subfigure}{.49\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{figures/chapter6/fig_01b.png}
		\caption{}
		\label{fig:sub2}
	\end{subfigure}
	\caption{}
