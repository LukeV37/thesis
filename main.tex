...
% ADVANCING EXPERIMENTAL HIGH ENERGY PHYSICS WITH MACHINE LEARNING ALGORITHMS
% IMPROVING ATLAS SENSITIVITY TO NEW PHYSICS WITH MACHINE LEARNING METHODS
% Probing the Higgs, Top Quark Entanglement, and Mitigating Pileup with Machine Learning Methods in High Energy Physics
