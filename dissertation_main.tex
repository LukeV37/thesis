...
\title{Title here}
\formattedtitle{FORMATTED TITLE WITH LINE BREAKS IN\\
                  INVERTED TRIANGLE\\
                  FORM}

\author{NAME IN ALL CAPS}

\degreeone{\ssp Bachelor of Science in Mathematics\\
        First Institution\\
        City, State\\
        2010}

\degreetwo{\ssp Master of Science in Mathematics\\
        University Two\\
        City, State\\
        2012}
...
\makeapproval{Dr. Advisor Name}{Dr. Second Reader}{Dr. Third Reader}{Dr. Outside Member}
...
\begin{abstract}{NAME HERE}
{DECEMBER, MAY, OR, JULY, 2020}
